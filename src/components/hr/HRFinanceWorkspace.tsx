...
export function HRFinanceWorkspace({ orgId, userId, members, profileMap, activeRole }: WorkspaceProps) {
  ...
  const [salary, setSalary] = useState(blank({ employee: "", start: today().slice(0, 8) + "01", end: today(), bank: "none", accountNumber: "", gross: "", voluntary: "", deductions: "", loan: "" }));
