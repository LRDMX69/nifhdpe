...
const ENTRIES: Entry[] = [
  ...
  { q: "How do I create a waybill for the driver?", a: "Open Logistics → New Waybill. Add the destination, driver, vehicle, and items — a printable waybill PDF is generated and recorded for the trip.", action: { label: "Open New Waybill", path: "/logistics?new=waybill" }, tags: ["waybill","driver","police","checkpoint","dispatch"] },
  ...
  { q: "How do I generate an employee ID card?", a: "HR → ID Cards → select an employee → Generate ID Card.", action: { label: "Open ID Cards", path: "/hr?tab=idcards" }, tags: ["id","card","employee"] },
  ...
  { q: "How do I see every document we have issued?", a: "Documents → Document Registry — a searchable list of every invoice, quotation, receipt, waybill, PO, and other issued record with its reference number.", action: { label: "Open Document Registry", path: "/documents" }, tags: ["registry","number","reference","history"] },
