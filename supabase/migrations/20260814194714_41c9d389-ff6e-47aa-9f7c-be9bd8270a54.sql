-- Payment date connector. Replaces the six-argument function with a version that
-- lets the Finance dialog post the authoritative receipt date.

DROP FUNCTION IF EXISTS public.record_invoice_payment(uuid, uuid, numeric, text, text, text);
