...
CREATE POLICY "Authorized users can manage sales orders" ON public.sales_orders FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'reception_sales') OR has_org_role(auth.uid(), organization_id, 'accountant')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'reception_sales') OR has_org_role(auth.uid(), organization_id, 'accountant'));
CREATE POLICY "Authorized users can manage sales order items" ON public.sales_order_items FOR ALL USING (EXISTS (SELECT 1 FROM public.sales_orders o WHERE o.id = sales_order_items.sales_order_id AND (has_org_role(auth.uid(), o.organization_id, 'administrator') OR has_org_role(auth.uid(), o.organization_id, 'reception_sales') OR has_org_role(auth.uid(), o.organization_id, 'accountant')))) WITH CHECK (EXISTS (SELECT 1 FROM public.sales_orders o WHERE o.id = sales_order_items.sales_order_id AND (has_org_role(auth.uid(), o.organization_id, 'administrator') OR has_org_role(auth.uid(), o.organization_id, 'reception_sales') OR has_org_role(auth.uid(), o.organization_id, 'accountant'))));
CREATE POLICY "Warehouse and admins manage reservations" ON public.inventory_reservations FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'warehouse_manager') OR has_org_role(auth.uid(), organization_id, 'reception_sales')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'warehouse_manager') OR has_org_role(auth.uid(), organization_id, 'reception_sales'));
CREATE POLICY "Warehouse and admins manage stock movements" ON public.stock_movements FOR INSERT WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'warehouse_manager'));
CREATE POLICY "Authorized users manage project work packages" ON public.project_work_packages FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'engineer')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'engineer'));
CREATE POLICY "Technical users manage fusion joints" ON public.fusion_joints FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'technician')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'technician'));
...
CREATE POLICY "Commercial users manage product specifications" ON public.product_specifications FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'reception_sales') OR has_org_role(auth.uid(), organization_id, 'warehouse_manager')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'reception_sales') OR has_org_role(auth.uid(), organization_id, 'warehouse_manager'));
CREATE POLICY "Authorized users manage handover records" ON public.project_handover_records FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'accountant')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'site_supervisor') OR has_org_role(auth.uid(), organization_id, 'accountant'));
...
DECLARE
  ...
  order_no text;
BEGIN
  IF NOT (has_org_role(auth.uid(), _org_id, 'administrator') OR has_org_role(auth.uid(), _org_id, 'reception_sales') OR has_org_role(auth.uid(), _org_id, 'accountant')) THEN
