...
CREATE POLICY "Authorized users manage project work packages" ON public.project_work_packages FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer'));
CREATE POLICY "Technical users manage fusion joints" ON public.fusion_joints FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'technician')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'technician'));
...
CREATE POLICY "Authorized users manage handover records" ON public.project_handover_records FOR ALL USING (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'finance')) WITH CHECK (has_org_role(auth.uid(), organization_id, 'administrator') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'engineer') OR has_org_role(auth.uid(), organization_id, 'finance'));
