...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.procurement_demands TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.delivery_items TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.project_material_consumptions TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.project_equipment_assignments TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.project_qa_records TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.service_ticket_parts TO authenticated;
GRANT ALL ON public.procurement_demands TO service_role;
GRANT ALL ON public.delivery_items TO service_role;
GRANT ALL ON public.project_material_consumptions TO service_role;
GRANT ALL ON public.project_equipment_assignments TO service_role;
GRANT ALL ON public.project_qa_records TO service_role;
GRANT ALL ON public.service_ticket_parts TO service_role;
...
DROP POLICY IF EXISTS "Members view procurement demands" ON public.procurement_demands;
...
DROP POLICY IF EXISTS "Commercial and warehouse manage procurement demands" ON public.procurement_demands;
...
DROP POLICY IF EXISTS "Members view delivery items" ON public.delivery_items;
...
DROP POLICY IF EXISTS "Warehouse manages delivery items" ON public.delivery_items;
...
DROP POLICY IF EXISTS "Members view project material consumptions" ON public.project_material_consumptions;
CREATE POLICY "Members view project material consumptions" ON public.project_material_consumptions FOR SELECT USING (is_member_of_org(auth.uid(), organization_id));
DROP POLICY IF EXISTS "Technical users manage material consumption" ON public.project_material_consumptions;
...
DROP POLICY IF EXISTS "Members view project equipment assignments" ON public.project_equipment_assignments;
CREATE POLICY "Members view project equipment assignments" ON public.project_equipment_assignments FOR SELECT USING (is_member_of_org(auth.uid(), organization_id));
DROP POLICY IF EXISTS "Technical users manage equipment assignments" ON public.project_equipment_assignments;
...
DROP POLICY IF EXISTS "Members view project QA records" ON public.project_qa_records;
CREATE POLICY "Members view project QA records" ON public.project_qa_records FOR SELECT USING (is_member_of_org(auth.uid(), organization_id));
DROP POLICY IF EXISTS "Technical users manage QA records" ON public.project_qa_records;
...
DROP POLICY IF EXISTS "Members view service ticket parts" ON public.service_ticket_parts;
CREATE POLICY "Members view service ticket parts" ON public.service_ticket_parts FOR SELECT USING (is_member_of_org(auth.uid(), organization_id));
DROP POLICY IF EXISTS "Technical users manage service ticket parts" ON public.service_ticket_parts;
