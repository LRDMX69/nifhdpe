...
serve(async (req: Request) => {
  ...
  try {
    ...
    const aiResult = await callAI(
      "You are an AI executive assistant for NIF Technical, generating daily operational intelligence briefs.",
      prompt,
      { organizationId: organization_id, functionName: "daily-summary", strictSpendCap: isScheduled },
    );
